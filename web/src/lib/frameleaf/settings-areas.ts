...
/** Library care is the hub for fixing things, so its directory also lists these utility tools. */
export const CARE_TOOLS = ['duplicates', 'missing-media', 'corrupt-media', 'live-photos'] as const;
