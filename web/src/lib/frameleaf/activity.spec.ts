...
describe('fromMediaOperation', () => {
  it('reports the destination explicitly', () => {
    ...
    expect(fromMediaOperation(operation({ destination: MediaOperationDestination.FrameleafCloud })).destinationKey).toBe(
      'frameleaf_activity_destination_frameleaf_cloud',
    );
