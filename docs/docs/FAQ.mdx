...
Frameleaf is built on Immich, which is open source under the GNU AGPL v3 License. Frameleaf is available as open source under the same license. You are welcome to use Frameleaf for commercial purposes, subject to the terms of the GNU AGPL v3 License.
