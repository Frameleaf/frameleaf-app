...
:::info
If you only have a single machine to run Frameleaf on, scaling to multiple containers is unlikely to provide any benefit. An Frameleaf container will run multiple background tasks at once, and you can increase their number from the admin panel.
:::
