...
The user-supplied seven-SVG kit in `design/frameleaf/brand-kit` is the authoritative artwork. Preserve originals and record platform derivatives; earlier generated PNGs are references, not release masters. Follow the committed [design handoff](../../../../design/frameleaf/README.md), manifest and file hashes for actual variants, theme contrast and platform export requirements. The additional dirty-checkout brand narrative is not restored by this slice.
