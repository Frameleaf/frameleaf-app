...
The user-supplied seven-SVG kit in `design/frameleaf/brand-kit` is the authoritative artwork. Preserve originals and record platform derivatives; earlier generated PNGs are references, not release masters. Follow the committed [design handoff](../../../../design/frameleaf/README.md), [brand preservation contract](06-brand-assets.md), manifest and file hashes for actual variants, theme contrast and platform export requirements. Source preservation does not establish web/native integration or release qualification.
