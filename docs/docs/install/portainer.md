...
9. Copy the content of the `example.env` file from the [Frameleaf release](https://github.com/Frameleaf/frameleaf-app/releases/latest/download/example.env) and paste into the editor.
