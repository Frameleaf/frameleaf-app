...
Create a directory of your choice (e.g. `./immich-app`) to house Frameleaf. In general, it's best practice to have all Docker-based applications running under the `./docker` directory, so in this case, your directory structure will look like `./docker/immich-app`.
...
Open **Container Manager**. Select **Project** then your Frameleaf app
