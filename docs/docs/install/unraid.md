...
9.  Once on the Docker page you will see several Immich containers, one of them will be labelled `frameleaf_server` and will have a port mapping. Visit the `IP:PORT` displayed in your web browser and you should see the Immich admin setup page.
...
<details >
    ...
    <p>If you are using the FolderView plugin go the Docker tab and select "<b>New Folder</b>".<br />Label it <i>"Immich"</i> and use this URL as the logo: https://raw.githubusercontent.com/Frameleaf/frameleaf-app/refs/heads/fork/main/mobile/assets/frameleaf-symbol.png<br/>Then simply select all the Immich related containers before clicking "<b>Submit</b>"</p>
    <img
