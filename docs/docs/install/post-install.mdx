...
A list of common steps to take after installing Frameleaf include:
...
- [External Libraries](/features/libraries.md): Adding your existing photo library to Frameleaf
- [Hardware Transcoding](/features/hardware-transcoding.md): Speeding up video transcoding
- [Hardware-Accelerated Machine Learning](/features/ml-hardware-acceleration.md): Speeding up various machine learning tasks in Frameleaf
