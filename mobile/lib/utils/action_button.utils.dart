...
import 'package:immich_mobile/presentation/actions/nsfw.action.dart';
...
enum ActionButtonType {
  ...
  Widget buildButton(
    ...
    return switch (this) {
      ...
      ActionButtonType.markNsfw => ActionMenuItem(action: MarkNsfwAction(source: context.source)),
      ActionButtonType.markSafe => ActionMenuItem(action: MarkSafeAction(source: context.source)),
