...
- [關於](https://help.frameleaf.ai/overview/quick-start)
- [安裝](https://help.frameleaf.ai/install/requirements)
- [發展藍圖](https://immich.app/roadmap)
- [線上體驗](#線上體驗)
- [功能](#功能)
- [翻譯](https://help.frameleaf.ai/developer/translations)
- [貢獻指南](https://help.frameleaf.ai/overview/support-the-project)
...
更多翻譯相關資訊請見 [此處](https://help.frameleaf.ai/developer/translations)。
