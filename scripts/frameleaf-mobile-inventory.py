...
GAPS = [
 ...
 ('native-studio', 'Project/revision/source review exists in preview; native graph editing, effects/animation/audio and qualified render/export remain unavailable'),
