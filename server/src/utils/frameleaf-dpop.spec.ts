...
describe('DPoP for Frameleaf Cloud instance tokens (FL-178)', () => {
  ...
  describe('isNonceChallenge', () => {
    it.each([
      ...
      // the bare token form (RFC 7235 section 2.1), ending at a delimiter or the end
      [401, undefined, 'DPoP error=use_dpop_nonce', true],
      [401, undefined, 'DPoP error=use_dpop_nonce, algs="EdDSA"', true],
      [401, undefined, 'DPoP error = use_dpop_nonce ,algs="EdDSA"', true],
      [401, undefined, 'DPoP error=use_dpop_nonce_other', false],
      [401, undefined, 'DPoP error=use_dpop_nonces', false],
      [401, undefined, 'DPoP error="use_dpop_nonce_later"', false],
      [401, undefined, 'DPoP myerror="use_dpop_nonce"', false],
