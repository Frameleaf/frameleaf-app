...
describe('catalog manifests', () => {
  ...
  it('derives deterministic complete lock sets for both installation classes', () => {
    ...
    // 131 public (v3.1.0, the post-certified residue cluster_group, cluster_group_request, person_group,
    // person_group_audit, workflow_log, and the legacy fork tables of the 2100000000NNN migrations, including
    // the FL-64 develop_preset and develop_export tables of 540, the four FL-74 preservation tables of 510,
    // and the FL-60 classification_rule and classification_match tables of 610)
    // + 33 fork tables, including seven iCloud tables and asset_develop_revision
    expect(getCatalogTableLocks(fork)).toHaveLength(164);
