...
describe('catalog manifests', () => {
  ...
  it('derives deterministic complete lock sets for both installation classes', () => {
    ...
    // 131 public (v3.1.0, the post-certified residue, legacy fork tables, FL-64 develop tables,
    // FL-74 preservation tables, and FL-82 workflow_definition and workflow_log_detail)
